...
class NoteAPITest {
    ...
    inner class PersistenceTest{
        ...
        // Test saving and loading empty ArrayList
        @Test
        fun `saving and loading empty collection to avoid crashing`(){
            // Saving an empty file
            val storingNotes = NoteAPI(XMLSerializer(File("notes.xm")))
            storingNotes.store()
        ...
        // Test saving and loading collection -> check for data persistence
        @Test
